...
Как мы видим, удалось выявить 11 специализаций:
⋅⋅* Обслуживание серверов и сетей;
⋅⋅* Разработчик промышленных систем/контроллеров;
⋅⋅* Разработчик ERP-систем (1С, SAP);
⋅⋅* Программирование станков;
⋅⋅* Общие навыки прграммирования
⋅⋅* Разработчик под Microsoft со знанием БД
⋅⋅* Веб-разработчик
⋅⋅* Разработчик под macOS/iOS'

Специализации довольно тесно взаимосвязаны. Это объясняется нашим основным предположением, что одна вакансия может иметь несколько специализаций. 
